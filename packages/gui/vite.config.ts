    ...
    build: {
        ...
        rolldownOptions: {
            input: {
                ...
                "pages/owner-transformations/client": resolve(
                    __dirname,
                    "src/pages/owner-transformations/client.ts",
                ),
                ...
                "pages/owner-agent-detail/client": resolve(
                    __dirname,
                    "src/pages/owner-agent-detail/client.ts",
                ),
